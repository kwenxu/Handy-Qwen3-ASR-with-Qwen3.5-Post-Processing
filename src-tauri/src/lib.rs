...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            shortcut::change_script_hooks_enabled_setting,
            shortcut::change_post_asr_script_path_setting,
            shortcut::change_post_llm_script_path_setting,
            shortcut::change_script_hook_timeout_ms_setting,
            shortcut::export_default_script_hook_templates,
            shortcut::restore_default_script_hook_templates,
            shortcut::export_script_stage_to_desktop,
            shortcut::import_script_stage_from_path,
            shortcut::test_script_hook,
        ...
        .setup(move |app| {
            ...
            let mut win_builder =
                tauri::WebviewWindowBuilder::new(app, "main", tauri::WebviewUrl::App("/".into()))
                    .title("Handy")
                    .inner_size(760.0, 570.0)
                    .min_inner_size(760.0, 570.0)
                    .resizable(true)
                    .maximizable(false)
                    .visible(false);
