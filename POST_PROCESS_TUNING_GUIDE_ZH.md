...
| 参数 | 默认值 | UI可调范围 |
|---|---:|---:|
| max_tokens | 768 | 64 ~ 2048 |
| temperature | 0.07 | 0.00 ~ 1.00 |
| top_p | 0.82 | 0.10 ~ 1.00 |
| repetition_penalty | 1.15 | 1.00 ~ 1.50 |
| repetition_context_size | 224 | 32 ~ 256 |
